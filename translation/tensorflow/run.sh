...
python3 transformer/transformer_main.py --random_seed=$SEED \
  --data_dir=processed_data/ --model_dir=model --params=big \
  --train_steps=1000
  #--bleu_threshold $QUALITY --bleu_source=newstest2014.en --bleu_ref=newstest2014.de
